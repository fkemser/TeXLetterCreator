...
readonly L_ABOUT_AUTHORS="Florian Kemser and the TeXLetterCreator contributors"
...
#  '.' out.
readonly L_ABOUT_DESCRIPTION="a collection of shell scripts to interactively create and print TeX-based form letters"
...
readonly L_ABOUT_PROJECT="TeXLetterCreator"
...
readonly L_ABOUT_YEARS="2023-2024"